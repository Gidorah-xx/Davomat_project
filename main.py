...
API_TOKEN = '7766142046:AAHtTK89kj7TxOr1LtMUMVJ6Ky-oaloV9tk'
...
async def start_bot(bot: Bot):
    await bot.send_message(6021701531,"Bot ishga tushdi !! ")

async def shutdown_bot(bot: Bot):
    await bot.send_message(6021701531,"Bot o'chdi !! ")
